...
{
    public void DisplayAnalysis(LiveAnalysisResult result)
    {
    ...
    private void DisplayHeader(LiveAnalysisResult result)
    {
        var panel = new Panel(
    ...
    private void DisplayDataWarning(string warning)
    {
    ...
    private void DisplayCurrentMarketData(LiveAnalysisResult result)
    {
    ...
    private void DisplayPrediction(LiveAnalysisResult result)
    {
    ...
    private void DisplayFeatureBreakdown(MarketFeatures features)
    {
    ...
    private void DisplayModelMetadata(LiveAnalysisResult result)
    {
    ...
    private string FormatPriceChange(decimal change)
    {
        if (change > 0)
    ...
    private string FormatPercentChange(decimal percent)
    {
        if (percent > 0)
    ...
    private string FormatPredictedReturn(float returnValue)
    {
    ...
    private string CalculateConfidence(float returnValue)
    {
    ...
    private string FormatFloat(float value, bool colorCode = false)
    {
        if (!colorCode)
