...
public partial class LeftSidebar : ComponentBase
{
    ...
    [
        ...
        new()
        {
            ...
            Href = "/workspace",
            Group = "Workspace",
            Description = "Unified workflow: Define → Test → Optimize → Deploy",
            Category = IconCategory.Workspace
        },
        ...
        new()
        {
            ...
            Description = "Browse built-in and custom strategies",
        ...
        new()
        {
            ...
            Href = "/backtests",
            Group = "Strategy Research",
            Description = "View backtest history and results",
            Category = IconCategory.Strategy
        },
        ...
        new()
        {
            ...
            Description = "Import historical market data",
        ...
        new()
        {
            ...
            Href = "/data/status",
            Group = "Data Management",
            Description = "View data coverage and quality",
            Category = IconCategory.Data
        },
    ...
    {
        const string baseClasses = "fixed top-16 left-0 bottom-0 z-30 transition-all duration-300";
    ...
    private class NavItem
    {
        ...
        public IconCategory Category { get; init; } = IconCategory.Default;
    }
}
