...
public class PriceTests
{
    ...
    {
        // Act
        Price price = new Price(150.50m, "USD");
    ...
    {
        // Act & Assert
        Should.Throw<ArgumentException>(() => new Price(-10m, "USD"));
    }
    ...
    {
        // Arrange
        Price a = new Price(150m, "USD");
        Price b = new Price(100m, "USD");
    ...
    {
        // Arrange
        Price a = new Price(100m, "USD");
        Price b = new Price(150m, "USD");
    ...
    {
        // Arrange
        Price oldPrice = new Price(100m, "USD");
        Price newPrice = new Price(120m, "USD");
    ...
    public void PercentageChangeTo_WithDecrease_ReturnsNegativePercentage()
    {
        // Arrange
        Price oldPrice = new Price(100m, "USD");
        Price newPrice = new Price(80m, "USD");
    ...
    public void PercentageChangeTo_WithZeroOldPrice_ReturnsZero()
    {
        ...
        Price newPrice = new Price(100m, "USD");
    ...
    {
        // Arrange
        Price price = new Price(1234.56m, "USD");
    ...
    {
        // Arrange
        Price price = new Price(1234.567m, "USD");
