...
public interface ICashBufferManager
{
    ...
    /// If cash ratio &gt; MAX and COIN &gt; MA20: buys with excess cash.
    /// </summary>
    /// <param name="strategyId">The strategy identifier.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>Cash buffer adjustment result with details.</returns>
    Task<CashBufferAdjustmentResult> AdjustCashBufferAsync(
        Guid strategyId,
    ...
    /// <summary>
    /// Executes cash buffer adjustment and returns order ID.
    /// </summary>
    /// <param name="strategyId">The strategy identifier.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
